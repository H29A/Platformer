...
namespace Platformer
{
    static public class Values
    {
        ...
        static public readonly Vector2 playerStartPosition = new Vector2(0, 0); /**/
        public const float playerStep = 3;
        public const string sptPlayer = "Sprites/Animated/Player";
        static public readonly Vector2 playerFrameSize = new Vector2(100, 100); /**/
        static public readonly Point playerTiles = new Point(5, 5); /**/
    }
}
